...
const supabaseKey = env.VITE_SUPABASE_ANON_KEY || env.SUPABASE_ANON_KEY || env.SUPABASE_KEY // Use ANON key for login simulation
...
async function checkAccess() {
    console.log("--- Logging in as admin@toolcrib.com ---")
