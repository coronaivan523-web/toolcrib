...
// Hardcoded for debugging - extracted from env
const supabaseUrl = 'https://bykumuizmxsclsazeych.supabase.co'
const supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ5a3VtdWl6bXhzY2xzYXpleWNoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjUzODU4NDQsImV4cCI6MjA4MDk2MTg0NH0.R2h9i6n7eL4aX_k2yJ2yV-X8e_5Z4qS-X3j_1a-X2h'
...
async function testSupervisorPermissions() {
    ...
    const { error: updateError } = await supabase
        .from('materials')
        .update({ current_stock: materials.current_stock }) // No change, just testing permissions
        .eq('id', materials.id)
